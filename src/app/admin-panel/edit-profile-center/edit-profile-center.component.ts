...
@Component({
    selector: 'app-edit-profile-center',
    templateUrl: './edit-profile-center.component.html',
    styleUrls: ['./edit-profile-center.component.scss']
})
export class EditProfileCenterComponent implements OnInit {
    ...
    makeForm() {
        ...
        const user = this.selectedCenterData
        if (this.centerId > -1) {
            this.profileFG = this.fb.group({
                ...
                contact_1: new FormControl(user.center.contact_1, [Validators.required, Validators.maxLength(15)]),
                contact_2: new FormControl(user.center.contact_2, [Validators.maxLength(15)]),
                level_id: new FormControl(user.center.level_id, [Validators.maxLength(15)]),
                district_id: new FormControl(user.center.district_id, [Validators.required, Validators.maxLength(15)]),
                region_id: new FormControl(user.center.region_id, [Validators.required, Validators.maxLength(15)]),
                description: new FormControl(user.center.description, [Validators.maxLength(500)]),
                address_1: new FormControl(user.center.address_1, [Validators.required, Validators.maxLength(500)]),
                address_2: new FormControl(user.center.address_2, [Validators.maxLength(500)]),
                address_3: new FormControl(user.center.address_3, [Validators.maxLength(500)]),
                established: new FormControl(user.center.established, [Validators.required, Validators.max(moment().year())]),
                web_url: new FormControl(user.center.web_url, []),
                fee: new FormControl(user.fee, [Validators.required]),

            })
            this.thumbnail = this.api.userImageUrl(this.selectedCenterData.id)
        } else {
            this.profileFG = this.fb.group({
