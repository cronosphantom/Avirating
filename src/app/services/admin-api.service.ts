...
export class AdminApiService {
    ...
    cancelSubscription(params): Observable<any> {
        const url = `${this.baseUrl}/cancel-subscription`
    ...
    getReportData(params): Observable<any> {
        const url = `${this.baseUrl}/get-reportData`

        return this.http.post<any>(url, params)
    }

    rejectReport(params): Observable<any> {
        const url = `${this.baseUrl}/reject-report`

        return this.http.post<any>(url, params)
    }

    approveReport(params): Observable<any> {
        const url = `${this.baseUrl}/approve-report`
